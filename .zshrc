...
export ZSH="/Users/evreykh/.oh-my-zsh"
...
plugins=(git colored-man-pages compleat command-not-found brew zsh-autosuggestions zsh-completions zsh-history-substring-search)
...
export PATH=$HOME/.composer/vendor/bin:$HOME/go/bin:./vendor/bin:./node_modules/.bin:$PATH
